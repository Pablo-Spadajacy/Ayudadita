...
<script>
	...
	<div class = "container">
		...
		<form id = "filtradoForm" action = "/chats/filtrado" method = "GET">
			<button type = "button" class = "btn btn-success" onClick = "filtrar('facultad')">Mi facultad</button>
			<button type = "button" class = "btn btn-success" onClick = "filtrar('carrera')">Mi carrera</button>
		...
		<div id = "todosUsuarios">
			...
			<c:forEach items = "${todosUsuarios}" var = "usuario">
				...
				<a href = "/usuario/chat/${usuario.id}"><h3>${usuario.nombre} ${usuario.apellido} <img src="/img/${usuario.avatar}" alt="Avatar de ${usuario.nombre}" class="avatar-img"/></h3></a>
