...
<style>
    ...
    .btn-custom-primary {
        background-color: #d6bfa6; /* Color marrón más claro */
        color: white;
        border: none;
    }
                        ...
                        <div class="card border-custom-success">
                            ...
                            <div class="card-body">
                                <c:forEach items="${forosTuCarrera}" var="foroTuCarrera">
                                    <a href="/foro/tema/${foroTuCarrera.id}" class="btn btn-custom-success w-100 mb-2">${foroTuCarrera.nombreForo}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-custom-primary">
                            ...
                            <div class="card-body">
                                <c:forEach items="${foroOtrasCarreras}" var="foroOtraCarrera">
                                    <a href="/foro/tema/${foroOtraCarrera.id}" class="btn btn-custom-primary w-100 mb-2">${foroOtraCarrera.nombreForo}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-custom-success">
                            ...
                            <div class="card-body">
                                <c:forEach items="${forosTuFacultad}" var="foroTuFacultad">
                                    <a href="/foro/tema/${foroTuFacultad.id}" class="btn btn-custom-success w-100 mb-2">${foroTuFacultad.nombreForo}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-custom-primary">
                            ...
                            <div class="card-body">
                                <c:forEach items="${foroOtrasFacultades}" var="foroOtraFacultad">
                                    <a href="/foro/tema/${foroOtraFacultad.id}" class="btn btn-custom-primary w-100 mb-2">${foroOtraFacultad.nombreForo}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
